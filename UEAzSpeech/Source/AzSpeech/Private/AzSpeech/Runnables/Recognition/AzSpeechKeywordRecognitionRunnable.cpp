...
uint32 FAzSpeechKeywordRecognitionRunnable::Run()
{
	...
	{
		UE_LOG(LogAzSpeech_Internal, Error, TEXT("Thread: %s; Function: %s; Message: Speech recognizer is invalid"), *GetThreadName(), *FString(__FUNCTION__));
		return 0u;
	}
	...
	{
		UE_LOG(LogAzSpeech_Internal, Error, TEXT("Thread: %s; Function: %s; Message: Speech task is invalid"), *GetThreadName(), *FString(__FUNCTION__));
		return 0u;
	}

	UE_LOG(LogAzSpeech_Internal, Warning, TEXT("Thread: %s; Function: %s; Message: Start keyword recognition async"), *GetThreadName(), *FString(__FUNCTION__));
