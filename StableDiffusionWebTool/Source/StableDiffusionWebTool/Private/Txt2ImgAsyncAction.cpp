...
UTxt2ImgAsyncAction::UTxt2ImgAsyncAction(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

UTxt2ImgAsyncAction* UTxt2ImgAsyncAction::Txt2ImgWithParamsFile(const UObject* WorldContextObject, const FString& InPrompt, const FString& InNegativePrompt, const FString& InParamsFilePath, const FString& InHostOrIP, int32 InPort)
{
...
UTxt2ImgAsyncAction* UTxt2ImgAsyncAction::Txt2ImgWithJsonString(const UObject* WorldContextObject, const FString& InJsonString, const FString& InHostOrIP, int32 InPort)
{
	...
	UTxt2ImgAsyncAction* Txt2ImgAsyncAction = NewObject<UTxt2ImgAsyncAction>();
...
void UTxt2ImgAsyncAction::Txt2ImgInternal(const UObject* WorldContextObject, const FString& InUrl, const FString& InPayload)
{
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UTxt2ImgAsyncAction::OnTxt2ImgCompleted);
	HttpRequest->ProcessRequest();
}

void UTxt2ImgAsyncAction::OnTxt2ImgCompleted(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bConnectedSuccessfully)
{
