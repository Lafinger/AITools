...
void UVoiceWakeUpSubsystem::StartInternal()
{
	...
	FString AbsoluteFilePath = FPaths::ConvertRelativePathToFull(FPaths::ProjectPluginsDir()) + "AITools/Workflows/Source/ThirdParty/VoiceWakeUpSdk/res/wakeupresource.jet";
